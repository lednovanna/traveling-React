const TabProgram  = () => {
    return <div className="card">
        ...
        <div className="card-title">
            ...
            <h4>Holiday near the sea</h4>
        </div>
        <div className="card-description">
            Lore lorem epspon uldopfaluo
            Lore lorem epspon uldopfaluo
    ...
    <div className="card-container">
        ...
        <div className="card-title">
            ...
            <h4>Нoliday in the mountains</h4>
        </div>
        <div className="card-description">
            Lore lorem epspon uldopfaluo
        </div>
